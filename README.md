...
`gbmbert-verify-local` is the canonical handoff check. It runs pytest, pip check, scope drift, the default training governance suite, compact platform regression, and artifact indexing in that order.
