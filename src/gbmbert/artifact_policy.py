...
REQUIRED_ARTIFACTS = (
    ...
    Path("reports/platform_regression/ci_summary_contract.json"),
    Path("reports/platform_regression/ci_summary_contract.md"),
    ...
    Path("reports/training/curated_provenance_diff.json"),
    Path("reports/training/curated_provenance_diff.md"),
    Path("reports/training/governance_detail_links.json"),
    Path("reports/training/governance_detail_links.md"),
    Path("reports/training/governance_detail_contract.json"),
    Path("reports/training/governance_detail_contract.md"),
    ...
    Path("reports/training/gold_pack/gold_pack_promotion_plan.json"),
    Path("reports/training/gold_pack/gold_pack_promotion_plan.md"),
)
